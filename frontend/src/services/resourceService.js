...
export function checkServerStatus(id) {
  return request({
    url: `/servers/${id}/check_status/`,  // 后端检查服务器状态接口
    method: 'get'
  })
}
...
export function getServerConfig(id) {
  return request({
    url: `/servers/${id}/config/`,  // 后端获取服务器配置接口
    method: 'get'
  })
}
